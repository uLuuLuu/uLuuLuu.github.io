globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-9OJs6mZV.js","assets/layout-segment-context-C3GJRWfv.js"];
...
function getDraftSecret() {
	return "39161482-e5c6-413f-9ff6-bf4f1436bca9";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "300749f6-5fa4-4569-928d-b4f1b66a5d92";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "300749f6-5fa4-4569-928d-b4f1b66a5d92") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "300749f6-5fa4-4569-928d-b4f1b66a5d92",
		rootBoundaryId
	});
}
/**
...
var metadata = {
	title: "Luu · 在行动中逐渐成为我",
	description: "一份关于 Luu 如何通过行动逐渐成为 Luu 的观察记录。"
};
